        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center   space-x-8">
            <button
              ...
              className="text-foreground text-blue-300 hover:text-blue-200 hover:scale-105 transition-smooth font-medium"
            >
              Home
            </button>
            <button
              onClick={() => scrollToSection('about')}
              className="text-foreground text-blue-300 hover:scale-105 hover:text-blue-200 transition-smooth font-medium"
            >
              About
            </button>
            <button
